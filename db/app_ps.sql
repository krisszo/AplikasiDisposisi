...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2010 at 06:21 AM
...
(7, 'Michael', 'pelajari', 'Biasa', '2022-03-07', 'test', 1, 1),
(12, 'Michael', 'Tindak Lanjuti Sesuai Ketentuan', 'Biasa', '2022-03-08', 'test', 7, 1),
(14, 'User', 'Buatkan Tanggapan / Kajian / Saran', 'Rahasia', '2010-01-01', 'ini adalah catatan', 13, 1),
(15, 'User', 'Tindak Lanjuti Sesuai Ketentuan', 'Biasa', '2010-01-01', 'ini adalah catatan', 15, 1),
(16, 'User', 'Tindak Lanjuti Sesuai Ketentuan', 'Biasa', '2010-01-01', 'ini adalah catatan', 15, 1);
...
CREATE TABLE IF NOT EXISTS `tbl_surat_masuk` (
  ...
  `keterangan` varchar(250) NOT NULL,
  `id_user` tinyint(2) NOT NULL,
  `approval_sekretaris` varchar(5) NOT NULL,
...
(7, 'user', '827ccb0eea8a706c4c34a16891f84e7b', 'User', '123456123', 3),
